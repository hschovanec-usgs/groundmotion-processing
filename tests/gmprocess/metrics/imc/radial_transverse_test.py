...
def test_radial_transverse():
    ...
    pgmdf = summary.pgms
    R = pgmdf[(pgmdf.IMT == 'PGA') & (pgmdf.IMC == 'R')].Result.iloc[0]
    T = pgmdf[(pgmdf.IMT == 'PGA') & (pgmdf.IMC == 'T')].Result.iloc[0]
    ...
    assert np.isnan(pgms[(pgms.IMT == 'PGA') & (pgms.IMC == 'R')].Result.iloc[0])
    assert np.isnan(pgms[(pgms.IMT == 'PGA') & (pgms.IMC == 'T')].Result.iloc[0])
