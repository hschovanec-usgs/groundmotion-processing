...
def test_to_dataframe():
    ...
    np.testing.assert_array_equal(df1.EPICENTRAL_DISTANCE.tolist(),
            [222.21249498025298, 222.21249498025298])
    np.testing.assert_array_equal(df1.HYPOCENTRAL_DISTANCE.tolist(),
            [222.36814794982126, 222.36814794982126])
